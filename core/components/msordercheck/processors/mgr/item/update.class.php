...
class msOrderCheckItemUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('msordercheck_item_err_ns');
        }
...
return 'msOrderCheckItemUpdateProcessor';
